...
For the Cartesian grid a straightforward method is used. By using a Moore neighborhood like grid the eight squares around the current square can be directly influenced. The neighborhood is shown in figure \ref{fig:cartesianstd}\\\\
